<template>
	<view class="box" :class="wosScroll">
		...
		<view v-if="isReady">
				...
				<view style="overflow: hidden;">
					...
					<view class="custom-info-content">
						...
						<view class="custom-info-content-line" @click="open('noticeVisible')"
							...
							<image style="width: 0.587rem;height: 0.5rem;" src="../../static/customDetail/next.png">
							</image>
						</view>
			...
			<!--铃铛-->
			<sop-bell ref='sopBell' :user_id='user_id' :chat_id='chat_id' :is_chat='1'
			          :agent_id='$route.query.agentId'></sop-bell>
			<!--sop弹框-->
			<sop-pop ref='sopPop' :user_id='user_id' :chat_id='chat_id' :is_chat='1'
			         :agent_id='$route.query.agentId'></sop-pop>
...
<script>
	...
	export default {
		name         : "list",
		inject       : ['initPage', 'getExternalId', 'getParameter', 'getChatId', 'forbidden', 'getContext', 'getCopyright','getPermissionButton'],
		components   : {dragButton, skeleton, Tag, Footer, SopBell, SopPop},
		data () {
			return {
				reasonList       : [],//输单原因
				lose             : '',//输单原因id
